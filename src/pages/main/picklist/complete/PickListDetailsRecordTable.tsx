...
export default function PickListDetailsRecordTable(props: {
  ...
  { title: "ICR Reference No", dataIndex: "icrReferenceNumber", key: "icrReferenceNumber" },
  ...
  return (
    <div>
      <Table<PickListDetailsRecordGetDTO>
        dataSource={pickListRecords}
        columns={columns}
        rowKey="id"
