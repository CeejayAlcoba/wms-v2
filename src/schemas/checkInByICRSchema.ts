...
export const checkInByICRSchema : yup.Schema<CheckInByICRDTO> =  yup.object().shape({
  bookingDetails: bookingDetailsSchema,
  cargoDetails: yup.array().of(cargoDetailsSchema).min(1, "At least one cargo detail is required").required(),
